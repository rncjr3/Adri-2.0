...
public class Constants {
    ...
    // in as 40.5.
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = Units.inchesToMeters(0.2794);
    public static final double DRIVETRAIN_WHEELBASE_METERS = Units.inchesToMeters(0.2794);
